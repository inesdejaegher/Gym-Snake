...
def extract_drug_reward(q_table_path):
    ...
    Example:
    q_table_drug_reward_25_no_growth_TIME_04_05_2026_17-49-47.pkl
    returns 25.
    """
...
def find_q_tables(q_table_dir):
    ...
    """
    pattern = os.path.join(q_table_dir, "q_table_drug_reward_*_no_growth_TIME_*.pkl")
...
def evaluate_q_table(q_table_path):
    ...
    logging.info(f"Saved evaluation results to: {full_csv_path}")
