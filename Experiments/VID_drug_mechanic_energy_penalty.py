...
pattern = os.path.join(q_table_dir, "DRUG_R10_ENG_PEN_FAC9_G1_Q_EP*_TIME_*.pkl")
...
if __name__ == "__main__":
    ...
    base_env.n_drugs = 1           # Baseline scenario: no drugs
    base_env.drug_reward = 10       # Baseline scenario: drugs have no effect
    base_env.drug_growth = 1       # Baseline scenario: drugs give no growth
    ...
    # -----------------------------------
    logging.info("Starting Drug-Energy Reward 10 - Growth 1 - Penalty Factor 9")
